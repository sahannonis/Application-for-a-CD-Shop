...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2018 at 11:15 AM
...
INSERT INTO `games` (`title`, `released_year`, `genre`, `quantity`) VALUES
('Assasinss Creed', 2007, 'Adventure', 20),
('CSGO', 2012, 'FPS', 10),
('GTA V', 2016, 'Open World', 7),
('HITMAN 2', 2018, 'Shooting', 10),
('Monster World', 2018, 'Open World', 5),
('OSU!', 2016, 'FPS', 20);
...
(54, 'GTA V', 'games', 1, NULL),
(55, 'GTA V', 'games', 1, NULL),
(56, 'GTA V', 'games', 1, NULL);
...
INSERT INTO `movies` (`title`, `released_year`, `genre`, `quantity`) VALUES
('Avengers 1', 2013, 'Action', 10),
('Avengers 2', 2016, 'Action', 10),
('Avengers Infinity War', 2018, 'Action', 10),
('John Wick Chapter 1', 2014, 'Action', 10),
('John Wick chapter 2', 2016, 'Action', 10);
...
INSERT INTO `tv` (`title`, `released_year`, `genre`, `no_of_seasons`, `quantity`) VALUES
('Game of Thrones', 2010, 'Fantasy', 7, 10),
('Legion', 2017, 'Fantasy', 2, 10),
('Lost in Space', 2017, 'Sci-Fii', 1, 10),
('Riverdale', 2017, 'Family', 3, 10),
('Vikings', 2012, 'Historical', 5, 10);
